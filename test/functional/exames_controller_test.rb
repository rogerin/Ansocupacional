...
class ExamesControllerTest < ActionController::TestCase
  ...
  test "should create exame" do
    assert_difference('Exame.count') do
      post :create, exame: { categoria_id: @exame.categoria_id, funcionario_id: @exame.funcionario_id, link: @exame.link }
    end
  ...
  test "should update exame" do
    put :update, id: @exame, exame: { categoria_id: @exame.categoria_id, funcionario_id: @exame.funcionario_id, link: @exame.link }
    assert_redirected_to exame_path(assigns(:exame))
  end
